                ...
                <div class="login-form">
					<el-form :model="registerForm" :rules="rules" ref="registerForm">
						...
						<el-form-item prop="adminID">
							<el-input type="text" 
                                v-model="registerForm.adminID" suffix-icon="el-icon-user-solid"
						...
						<el-form-item prop="jobNum">
							<el-input type="text" 
                                v-model="registerForm.jobNum" suffix-icon="el-icon-suitcase"
                                placeholder="请输入您的工号"></el-input>
						</el-form-item>
						<el-form-item prop="phone">
							<el-input type="text" 
                                v-model="registerForm.phone" suffix-icon="el-icon-phone"
                                placeholder="请输入您的手机号"></el-input>
						</el-form-item>
						<el-form-item>
							<el-row :gutter="20">
								<el-col :span="12">
									<el-button @click="submitForm('registerForm')" type="primary">管理员注册</el-button>
								</el-col>
								<el-col :span="12">
